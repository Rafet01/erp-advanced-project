		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Movement APP",
									"targetURL": "#erpadvancedmovementproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"erpadvancedmovementproject-display": {
								"semanticObject": "erpadvancedmovementproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=erpadvancedmovementproject",
									"url": sap.ui.require.toUrl("erpadvancedmovementproject")
								}
							}
						}
					}
